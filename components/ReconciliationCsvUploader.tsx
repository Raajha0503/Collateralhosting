...
const ReconciliationCsvUploader: React.FC<Props> = ({ collectionName, onUploadComplete }) => {
  ...
  return (
    <div>
      ...
      >
        ...
        />
        <p className="text-gray-200 text-lg font-semibold mb-2">Drag & drop reconciliation CSV file here, or click to select</p>
        <p className="text-gray-400 text-sm">Upload reconciliation data to {collectionName} collection</p>
...
export default ReconciliationCsvUploader; 